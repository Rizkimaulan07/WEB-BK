...
class TindakLanjutController extends Controller {
    public function store(Request $request, Kasus $kasus) {
        ...
        $data = $request->validate([
            ...
            'status_setelah' => 'required|in:Baru,Diproses (Konseling),Pemanggilan Orang Tua,SP1,SP2,Wakil Kesiswaan,Selesai',
        ]);
        ...
        return back()->with('success', 'Tindak lanjut berhasil ditambahkan dan status diperbarui!');
    }
